            ...
            <header>
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../Onglet Match/Onglet_Match.html">Saisir un match</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <tbody>
                        <?php while($row = $req->fetch(PDO::FETCH_ASSOC)) : ?>
                                    ...
                                    <tr class=<?php echo($pair)?>>
                                        ...
                                        <td class="icones_sur_ligne"><a href ="suppression.php?Nom=<?php echo $row['Nom']?>"><span class="iconify" data-icon="ci:edit" style="color: #383338; font-size: 20px;"></span>
                    ...
                    <form action="form_act_joueuse.php" method="post">
                        <div id="Section_champs_saisies">
                            ...
                            <div class="champ_saisie">
                                ...
                                <select class="form-control" id="poste" aria-label="Poste Joueuse" >
                                    ...
                                    <option value="7">Gardienne</option>
                                </select>
                            </div>
